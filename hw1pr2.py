...
if __name__ == '__main__':
	...
	y_space = []
	"*** YOUR CODE HERE ***"
	X_space = np.linspace(-1, 5, 100, False).reshape(-1,1)
	...
	noise = []
	"*** YOUR CODE HERE ***"
	# I looked at the solution for this line specifically bc my graph, 
	# specifically the randomization looked funky because I didn't have 
	# the reshaping of noise. 
	...
	print(y_space.size, noise.size, y_space_rand.size)
	"*** END YOUR CODE HERE ***"
	...
	W_opt = None
	"*** YOUR CODE HERE ***"
	W_opt = np.linalg.solve(np.transpose(X_space_stacked) @ X_space_stacked, \
		np.transpose(X_space_stacked) @ y_space_rand)
	"*** END YOUR CODE HERE ***"
